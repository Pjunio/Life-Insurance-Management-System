...
.input-group input {
    flex: 1;
    margin-right: 10px;
    margin-bottom: 0; /* Prevents extra spacing inside the group */
}
...
<div class="input-group">
    ...
    <button type="button" id="toggleConfirmPassword" class="toggle-btn">Show</button>
</div>
<span class="error" id="confirm_password_error"></span>
            ...
            <script>
                // Add toggle functionality for password
